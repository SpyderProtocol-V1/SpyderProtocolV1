...
pub const VERSION: RuntimeVersion = RuntimeVersion {
	spec_name: create_runtime_str!("Spyder"),
	impl_name: create_runtime_str!("Spyder"),
	authoring_version: 1,
	spec_version: 100,
	impl_version: 0,
...
parameter_types! {
	pub const AcalaTreasuryPalletId: PalletId = PalletId(*b"Spyder/trsy");
	pub const LoansPalletId: PalletId = PalletId(*b"Spyder/loan");
	pub const DEXPalletId: PalletId = PalletId(*b"Spyder/dexm");
	pub const CDPTreasuryPalletId: PalletId = PalletId(*b"Spyder/cdpt");
	pub const StakingPoolPalletId: PalletId = PalletId(*b"Spyder/stkp");
	pub const HonzonTreasuryPalletId: PalletId = PalletId(*b"Spyder/hztr");
	pub const HomaTreasuryPalletId: PalletId = PalletId(*b"Spyder/hmtr");
	pub const IncentivesPalletId: PalletId = PalletId(*b"Spyder/inct");
	// Decentralized Sovereign Wealth Fund
	pub const DSWFPalletId: PalletId = PalletId(*b"Spyder/dswf");
	pub const ElectionsPhragmenPalletId: LockIdentifier = *b"Spyder/phre";
	pub const NftPalletId: PalletId = PalletId(*b"Spyder/aNFT");
	pub UnreleasedNativeVaultAccountId: AccountId = PalletId(*b"Spyder/urls").into_account();
}
...
// parameter_types! {
// 	pub SpyderProtocol-V1: NetworkId = NetworkId::Named("Spyder".into());
...
// 	AccountId32Aliases<SpyderProtocol-V1, AccountId>,
// );
...
// 	SignedAccountId32AsNative<SpyderProtocol-V1, Origin>,
// );
	...
	impl frame_benchmarking::Benchmark<Block> for Runtime {
		fn dispatch_benchmark(
			...
			let whitelist: Vec<TrackedStorageKey> = vec![
				...
				hex_literal::hex!("26aa394eea5630e07c48ae0c9558cef702a5c1b19ab7a04f536c519Spyder4983ac").to_vec().into(),
				// Total Issuance
