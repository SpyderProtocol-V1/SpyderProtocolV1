...
// 					network: NetworkId::Named("Spyder".into()),
// 					id: ALICE,
// 				}),
// 			}],
// 		}
...
// 		// receive owned token
// 		let Spyder_amount = 1000 * dollar(ACA);
...
// 		assert_eq!(Currencies::free_balance(ACA, &ALICE.into()), Spyder_amount);
// 	});
// }
