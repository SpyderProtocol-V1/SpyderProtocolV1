...
use Spyder_primitives::{AccountId, Balance, Block, BlockNumber, CurrencyId, DataProviderId, Hash, Header, Nonce};
...
pub enum Client {
	...
	Acala(Arc<crate::FullClient<Spyder_runtime::RuntimeApi, crate::AcalaExecutor>>),
}
