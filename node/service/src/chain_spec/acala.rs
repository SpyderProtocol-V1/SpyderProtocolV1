...
use Spyder_primitives::{AccountId, TokenSymbol};
use hex_literal::hex;
...
pub type ChainSpec = sc_service::GenericChainSpec<Spyder_runtime::GenesisConfig, Extensions>;

pub const PARA_ID: u32 = 1000;

pub fn Spyder_config() -> Result<ChainSpec, String> {
	Err("Not available".into())
}

pub fn latest_Spyder_config() -> Result<ChainSpec, String> {
	...
	let wasm_binary = Spyder_runtime::WASM_BINARY.ok_or("Acala runtime wasm binary not available")?;
	...
	Ok(ChainSpec::from_genesis(
		...
		ChainType::Live,
		// SECRET="..."
		// ./target/debug/subkey inspect "$SECRET//Spyder//root"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//oracle"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//1//validator"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//1//babe"
		// ./target/debug/subkey --ed25519 inspect "$SECRET//Spyder//1//grandpa"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//2//validator"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//2//babe"
		// ./target/debug/subkey --ed25519 inspect "$SECRET//Spyder//2//grandpa"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//3//validator"
		// ./target/debug/subkey --sr25519 inspect "$SECRET//Spyder//3//babe"
		// ./target/debug/subkey --ed25519 inspect "$SECRET//Spyder//3//grandpa"
		move || {
			Spyder_genesis(
				wasm_binary,
				vec![
		...
		vec![
			//TODO
			"/dns/testnet-bootnode-1.Spyder.laminar.one/tcp/30333/p2p/12D3KooWAFUNUowRqCV4c5so58Q8iGpypVf3L5ak91WrHf7rPuKz"
				.parse()
				.unwrap(),
		],
...
fn Spyder_genesis(
	...
	let vesting_list_json = &include_bytes!("../../../../resources/Spyder-vesting-ACA.json")[..];
