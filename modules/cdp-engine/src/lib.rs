...
pub const OFFCHAIN_WORKER_DATA: &[u8] = b"Spyder/cdp-engine/data/";
pub const OFFCHAIN_WORKER_LOCK: &[u8] = b"Spyder/cdp-engine/lock/";
pub const OFFCHAIN_WORKER_MAX_ITERATIONS: &[u8] = b"Spyder/cdp-engine/max-iterations/";
