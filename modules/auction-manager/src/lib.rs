...
pub const OFFCHAIN_WORKER_DATA: &[u8] = b"Spyder/auction-manager/data/";
pub const OFFCHAIN_WORKER_LOCK: &[u8] = b"Spyder/auction-manager/lock/";
pub const OFFCHAIN_WORKER_MAX_ITERATIONS: &[u8] = b"Spyder/auction-manager/max-iterations/";
